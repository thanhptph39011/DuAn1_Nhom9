...
public class KhachHangFragment extends Fragment {
   ...
   ArrayList<KhachHang> tempList;
    ...
    private void opendialogAdd() {
        ...
        Button btnSave_itemAddKhachHang = view.findViewById(R.id.btnSave_itemAddKhachHang);
        Button btnHuy_itemAddKhachHang = view.findViewById(R.id.btnHuy_itemAddKhachHang);
